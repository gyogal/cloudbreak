package com.sequenceiq.billing.configuration.swagger;
...
public class CombinedSwaggerResourcesProvider implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        jerseySwaggerResource.setLocation(BillingApi.API_ROOT_CONTEXT + "/swagger.json");
        jerseySwaggerResource.setSwaggerVersion("2.0");
        jerseySwaggerResource.setName("Billing API");
