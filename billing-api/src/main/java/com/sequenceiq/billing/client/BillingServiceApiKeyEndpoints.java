...
public class BillingServiceApiKeyEndpoints extends AbstractKeyBasedServiceEndpoint implements BillingClient {

    protected BillingServiceApiKeyEndpoints(WebTarget webTarget, String accessKey, String secretKey) {
