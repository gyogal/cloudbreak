...
public class BillingServiceCrnEndpoints extends AbstractUserCrnServiceEndpoint implements BillingClient {

    BillingServiceCrnEndpoints(WebTarget webTarget, String crn) {
        super(webTarget, crn);
    }
