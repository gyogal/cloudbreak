...
public class DistroXResilientScaleTests extends AbstractE2ETest {
    ...
    @Description(
            ...
            when = "cluster has been scaled up at least 90% of the required node count",
                and = "cluster has been scaled up again at least 90% option while removing one of the instance from the host group",
            then = "cluster can be resiliently scaled up at least the required node count")
