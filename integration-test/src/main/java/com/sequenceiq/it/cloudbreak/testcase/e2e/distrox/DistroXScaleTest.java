...
public class DistroXScaleTest extends AbstractE2ETest {
    ...
    @Description(
            ...
            when = "deleted a Compute instance while cluster was upscaling",
            then = "cluster can be resAbstractMinimalTest.javailiently scaled up then down with higher node count")
